...
set cached_ip [config_ip_cache -export -no_bom -use_project_ipc -dir C:/VIVADO/tmp_edit_project.runs/rgb2dvi_0_synth_1 -new_name rgb2dvi_0 -ip [get_ips rgb2dvi_0]]
...
if { [catch {
  file copy -force C:/VIVADO/tmp_edit_project.runs/rgb2dvi_0_synth_1/rgb2dvi_0.dcp C:/VIVADO/tmp_edit_project.srcs/sources_1/ip/rgb2dvi_0/rgb2dvi_0.dcp
} _RESULT ] } { 
...
if { [catch {
  write_verilog -force -mode synth_stub C:/VIVADO/tmp_edit_project.srcs/sources_1/ip/rgb2dvi_0/rgb2dvi_0_stub.v
} _RESULT ] } { 
  puts "CRITICAL WARNING: Unable to successfully create a Verilog synthesis stub for the sub-design. This may lead to errors in top level synthesis of the design. Error reported: $_RESULT"
}

if { [catch {
  write_vhdl -force -mode synth_stub C:/VIVADO/tmp_edit_project.srcs/sources_1/ip/rgb2dvi_0/rgb2dvi_0_stub.vhdl
} _RESULT ] } { 
  puts "CRITICAL WARNING: Unable to successfully create a VHDL synthesis stub for the sub-design. This may lead to errors in top level synthesis of the design. Error reported: $_RESULT"
}

if { [catch {
  write_verilog -force -mode funcsim C:/VIVADO/tmp_edit_project.srcs/sources_1/ip/rgb2dvi_0/rgb2dvi_0_sim_netlist.v
} _RESULT ] } { 
  puts "CRITICAL WARNING: Unable to successfully create the Verilog functional simulation sub-design file. Post-Synthesis Functional Simulation with this file may not be possible or may give incorrect results. Error reported: $_RESULT"
}

if { [catch {
  write_vhdl -force -mode funcsim C:/VIVADO/tmp_edit_project.srcs/sources_1/ip/rgb2dvi_0/rgb2dvi_0_sim_netlist.vhdl
} _RESULT ] } { 
...
if { [catch {
  file rename -force C:/VIVADO/tmp_edit_project.runs/rgb2dvi_0_synth_1/rgb2dvi_0_stub.v C:/VIVADO/tmp_edit_project.srcs/sources_1/ip/rgb2dvi_0/rgb2dvi_0_stub.v
} _RESULT ] } { 
  puts "CRITICAL WARNING: Unable to successfully create a Verilog synthesis stub for the sub-design. This may lead to errors in top level synthesis of the design. Error reported: $_RESULT"
}

if { [catch {
  file rename -force C:/VIVADO/tmp_edit_project.runs/rgb2dvi_0_synth_1/rgb2dvi_0_stub.vhdl C:/VIVADO/tmp_edit_project.srcs/sources_1/ip/rgb2dvi_0/rgb2dvi_0_stub.vhdl
} _RESULT ] } { 
  puts "CRITICAL WARNING: Unable to successfully create a VHDL synthesis stub for the sub-design. This may lead to errors in top level synthesis of the design. Error reported: $_RESULT"
}

if { [catch {
  file rename -force C:/VIVADO/tmp_edit_project.runs/rgb2dvi_0_synth_1/rgb2dvi_0_sim_netlist.v C:/VIVADO/tmp_edit_project.srcs/sources_1/ip/rgb2dvi_0/rgb2dvi_0_sim_netlist.v
} _RESULT ] } { 
  puts "CRITICAL WARNING: Unable to successfully create the Verilog functional simulation sub-design file. Post-Synthesis Functional Simulation with this file may not be possible or may give incorrect results. Error reported: $_RESULT"
}

if { [catch {
  file rename -force C:/VIVADO/tmp_edit_project.runs/rgb2dvi_0_synth_1/rgb2dvi_0_sim_netlist.vhdl C:/VIVADO/tmp_edit_project.srcs/sources_1/ip/rgb2dvi_0/rgb2dvi_0_sim_netlist.vhdl
} _RESULT ] } { 
  puts "CRITICAL WARNING: Unable to successfully create the VHDL functional simulation sub-design file. Post-Synthesis Functional Simulation with this file may not be possible or may give incorrect results. Error reported: $_RESULT"
}
...
if {[file isdir C:/VIVADO/tmp_edit_project.ip_user_files/ip/rgb2dvi_0]} {
  catch { 
    file copy -force C:/VIVADO/tmp_edit_project.srcs/sources_1/ip/rgb2dvi_0/rgb2dvi_0_stub.v C:/VIVADO/tmp_edit_project.ip_user_files/ip/rgb2dvi_0
  }
}

if {[file isdir C:/VIVADO/tmp_edit_project.ip_user_files/ip/rgb2dvi_0]} {
  catch { 
    file copy -force C:/VIVADO/tmp_edit_project.srcs/sources_1/ip/rgb2dvi_0/rgb2dvi_0_stub.vhdl C:/VIVADO/tmp_edit_project.ip_user_files/ip/rgb2dvi_0
  }
}
